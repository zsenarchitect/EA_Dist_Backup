__doc__ = "A link to the EI page how to install EnneadTab for Revit. You have it, but your teammate might not, so this button is show them where to find the installation guide."
__title__ = "How to Install EnneadTab for Revit"
...
"""
image = script.get_bundle_file("instruction.png")
output.print_image(image)
output.set_width(1000)
output.set_height(1200)
output.center()
"""
import ENNEAD_LOG
ENNEAD_LOG.use_enneadtab(coin_change = 99, tool_used = "How to install EnneadTab for Revit.", show_toast = True)
