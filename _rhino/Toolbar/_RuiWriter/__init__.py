...
from constants import MAIN_FOLDER, SPECIAL_LIST_KEY, DISTIBUTION_RUI, SELF_USE_RUI

# add path to rhino ironpython lib and EA lib
sys.path.append(r"C:\Users\szhang\AppData\Roaming\McNeel\Rhinoceros\7.0\Plug-ins\IronPython (814d908a-e25c-493d-97e9-ee3861957f49)\settings\lib")
sys.path.append(r"C:\Users\szhang\AppData\Roaming\McNeel\Rhinoceros\7.0\Plug-ins\IronPython (814d908a-e25c-493d-97e9-ee3861957f49)\settings\lib\rhinoscript")
sys.path.append(r"C:\Users\szhang\github\EnneadTab-for-Rhino\Source Codes\lib")
sys.path.append(r"C:\Users\szhang\github\EnneadTab-for-Rhino\Source Codes\lib\EnneadTab")
...
class RuiWriter:
    ...
    def save_to_rui(self):
        ...
        for rui in [DISTIBUTION_RUI, SELF_USE_RUI]:
