...
def merge_material():
    ...
    mats_to_modify, mat_target = EnneadTab.RHINO.RHINO_FORMS.select_from_list2list(all_mat_names,
                                                                                    all_mat_names,
    ...
    if not mat_target or not mats_to_modify:
        EnneadTab.NOTIFICATION.toast(main_text = "Cannot deal with empty selection.")
        return
