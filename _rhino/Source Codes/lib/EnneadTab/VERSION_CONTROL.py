...
def install_EA_dist():
    ...
    exes = [ENVIRONMENT_CONSTANTS.EXE_FOLDER + "\\EnneadTab_OS_Installer.exe",
            ENVIRONMENT_CONSTANTS.PUBLIC_L_EXE_FOLDER + "\\EnneadTab_OS_Installer.exe",
            ENVIRONMENT_CONSTANTS.EXE_FOLDER + "\\EnneadTab_Installer.exe",
