...
import EnneadTab
EnneadTab.NOTIFICATION.toast(main_text = "V8 eto")
...
class ImageSelectionDialog(Eto.Forms.Dialog[bool]):
    ...
    def CreateSearchBar(self):
        ...
        self.button_clear_text.Click += self.clear_search_bar
    ...
    def CreateTagAssignment(self):
        ...
        self.btn_Run.ImagePosition = Eto.Forms.ButtonImagePosition.Right
        self.tag_assignment_refresh_button.Click += self.tag_assignment_refresh_button_Clicked
        ...
        for b_name in self.TAG_DEFAULT_LIST:
            ...
            self.btn_Run.Click += self.btn_Tag_Clicked
            #tag_buttons.append(None)
    ...
    def clear_search_bar(self, sender, e):
        self.tB_Search.Text = ""
    ...
    def tag_assignment_refresh_button_Clicked(self, sender, e):
        # close window after double click action. Otherwise, run with error
        self.update_item_tag_pool()
        self.Search()
    ...
    def btn_Tag_Clicked(self, sender, e):
