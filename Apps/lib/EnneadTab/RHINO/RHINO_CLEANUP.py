...
def purge_layer():
    if rs.ExeVersion() <= 7:
        ...
        rs.Command("_NoEcho -Purge _Pause _Materials=_No _BlockDefinitions=_No _AnnotationStyles=_No _Groups=_No _HatchPatterns=_No _Layers=_Yes _Linetypes=_No _Textures=_No Environments=_No _Bitmaps=_No _Enter")
...
def purge_material():
    if rs.ExeVersion() <= 7:
        ...
        rs.Command("_NoEcho -Purge _Pause _Materials=_Yes _BlockDefinitions=_No _AnnotationStyles=_No _Groups=_No _HatchPatterns=_No _Layers=_No _Linetypes=_No _Textures=_No Environments=_No _Bitmaps=_No _Enter")
...
def purge_block():
    if rs.ExeVersion() <= 7:
        ...
        rs.Command("_NoEcho -Purge _Pause _Materials=_No _BlockDefinitions=_Yes _AnnotationStyles=_No _Groups=_No _HatchPatterns=_No _Layers=_No _Linetypes=_No _Textures=_No Environments=_No _Bitmaps=_No _Enter")
