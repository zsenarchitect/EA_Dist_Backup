...
import random
import os
FORM_KEY = 'GameSoundModelessForm'
...
class GameSound(Eto.Forms.Form):
    ...
    def Initialize(self):
        ...
        self.title_logo.Image = temp_bitmap.WithSize(400,400)
    ...
    def CreateFormControls(self):
        ...
        # RHINO.RHINO_UI.apply_dark_style(self)
    ...
    def play_sound(self, file_name = None, is_announcer = False):
        ...
        folder = "{}\\sounds".format(self.script_folder)
