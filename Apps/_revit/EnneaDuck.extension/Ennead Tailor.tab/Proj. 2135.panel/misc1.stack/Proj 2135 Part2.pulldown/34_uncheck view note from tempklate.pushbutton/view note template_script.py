...
__doc__ = "Unbind the checkbox for view note and translation parameter from the view templates."
__title__ = "34_uncheck view note and translation from template"
...
templates = filter(lambda x: x.IsTemplate, views)
...
# for id in para_ids:
#     print x.Parameter().Defination.Name
#
