...
import imp
ref_module = imp.load_source("make walltype filter_script", r'{}\ENNEAD.extension\EnneadTab.tab\Tailor Shop.panel\misc1.stack\Proj 2135 Part2.pulldown\52_make walltype_filter and assign.pushbutton\make walltype filter_script.py'.format(EnneadTab.ENVIRONMENT.REVIT_FOLDER))
