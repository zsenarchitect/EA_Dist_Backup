__doc__ = "Worth revisiting idea, see newer color scheme api. "
__title__ = "update color scheme"
...
#print DB.ColorFillSchemeEntry(DB.StorageType.String)

color_schemes = DB.FilteredElementCollector(revit.doc).OfCategory(DB.BuiltInCategory.OST_ColorFillSchema).WhereElementIsNotElementType().ToElements()

"""
print(color_schemes)
for scheme in color_schemes:
    for para in scheme.Parameters:
        print(para.Definition.Name)
"""
color_scheme = forms.SelectFromList.show(context = color_schemes,
                                        name_attr = "Name",
                                        multiselect = False)
print(color_scheme)
"""
...
for entry in entries:
    print("*"*6)
    print(entry.Caption, entry.Color.R, entry.Color.G, entry.Color.B)
"""
