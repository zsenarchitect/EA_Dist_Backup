__doc__ = "DO NOT USE"
__title__ = "fix bili panel(DO NOT USE)"
...
"""
find bili panel with 'is BM'  to turn off railing mullion, 'is parapet' tp trim top arch, is panel B and triface flip to trim lower arch, and maybe find panel next to it also trim lower arch?
"""
