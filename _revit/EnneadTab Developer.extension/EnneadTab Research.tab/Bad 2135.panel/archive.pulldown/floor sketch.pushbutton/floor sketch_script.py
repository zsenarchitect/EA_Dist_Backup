__doc__ = "DO NOT USE, see new api for sketch element"
__title__ = "floor sketch(DO NOT USE)"
...
floor = revit.get_selection()[0]
print(floor)

floor_sketch_id = floor.Id.IntegerValue - 1
floor_sketch = revit.doc.GetElement(floor_sketch_id)
print(floor_sketch)
