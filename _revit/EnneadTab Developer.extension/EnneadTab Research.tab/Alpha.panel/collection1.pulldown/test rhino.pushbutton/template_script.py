...
filepath = str(r"C:\Users\szhang\Desktop\temp.3dm")
f.Read(filepath)
print(f)
...
print(rc)
#filepath = forms.pick_file(file_ext = "*")
filepath = str(r"C:\Users\szhang\Desktop\temp.3dm")

file3dm = rc.FileIO.File3dm()
file3dm.Read(filepath)
#file3dm.Read(filepath)
#print rc.RhinoDoc
print(file3dm)
print(filepath)
a = rc.Geometry.Point3d(0,0,0)
b = rc.Geometry.Point3d(100,10,0)
file3dm.Objects.AddLine(rc.Geometry.Line(a,b))
print(file3dm.Views.Count)
#print "XX{}".format(rc.FileIO.File3dmLayerTable())
#print file3dm.Created
print(file3dm.Layers)
print(file3dm.Layers.Count)
print(file3dm.Objects)
print(file3dm.Objects.Count)
...
"""
IDEAS
    - for family add subC and para, allow for user to self define.
