...
__title__ = "Reload All RVT Links"
...
rvtLinkTypes = DB.FilteredElementCollector(revit.doc).OfClass(DB.RevitLinkType).ToElements()
print(rvtLinkTypes)
#with revit.Transaction("reload all rvt link"):
...
try:
    rlt.Reload()
    print("{} reloaded".format(rlt.Parameter("Name")))
except:
    print("wrong with {}".format(rlt.Parameter("Name")))
"""
