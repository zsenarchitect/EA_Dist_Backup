...
__title__ = "Group2Family"

from pyrevit import forms, DB, revit, script
from Autodesk.Revit import UI # pyright: ignore

print(revit.doc.Application)
application = revit.doc.Application
TemplateFileName = r"L:\4b_Applied Computing\01_Revit\02_Template\02_Asia\EA_Family Templates\Metric_Detail Component.rft"
#TemplateFileName = "C:\Users\szhang\Desktop\Family1.rfa"
#TemplateFileName = "L:\4b_Applied Computing\01_Revit\02_Template\01_Imperial\EA_Family Templates\Detail Component.rft"
print(TemplateFileName)
file_path = DB.FilePath(TemplateFileName)
print(file_path, file_path.ServerPath, file_path.ToString())
family_doc = application.NewFamilyDocument(TemplateFileName)

print(family_doc)
#revit.uidoc.ActiveView = family_doc

UI.UIApplication.DoDragDrop()
UI.UIApplication.OpenAndActiveDocument()
UI.UIApplication.PostCommand()
UI.UIDocument.SaveAs()
