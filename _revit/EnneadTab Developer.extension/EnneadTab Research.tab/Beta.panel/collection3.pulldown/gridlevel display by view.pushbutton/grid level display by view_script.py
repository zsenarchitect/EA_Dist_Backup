...
"""
1, choose to do level or Grid
2, choose views that will affect
3, based on step one, choose all levels or all grid, from list that will show/hide by checkbox, becasue there are keyword search at top, this is a nature filter.
4, use that show/hide list to unhide/hide elevement from those views.



notes:
show look into the repyrevit select from list GUI so i can combine step 2 and 3 selection box, a action button for while loop, a radial switch to control do levels or grids
"""
