...
view = doc.ActiveView
print(view.Name)
rvts = DB.FilteredElementCollector(doc, view.Id).OfClass(DB.RevitLinkInstance).ToElements()
...
for doc in docs:
    print(doc.Title)
    cate = DB.Category.GetCategory(doc, DB.BuiltInCategory.OST_Areas)
    print(cate.Id)
