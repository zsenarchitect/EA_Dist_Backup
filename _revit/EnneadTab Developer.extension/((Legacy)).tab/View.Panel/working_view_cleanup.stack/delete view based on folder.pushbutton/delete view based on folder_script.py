...
__doc__ = "Based on the jpgs you placed in the folder, the tool will find the matching views and delete them from the file.\n\nUse this with the 'Export NonSheet view as jpg' tool."
__title__ = "Delete Views By Jpgs"
import ENNEAD_LOG
...
def is_view_in_folder(view):
    ...
    for file_name in file_names:
        if "Created By" in file_name:
            file_name = file_name.split("]_")[1]
        if view.Name == file_name.replace(".jpg", "") and ".jpg" in file_name.lower():
            return True
    return False
...
if __name__ == "__main__":
    main()
    ENNEAD_LOG.use_enneadtab(coin_change = total * 20, tool_used = __title__, show_toast = True)
