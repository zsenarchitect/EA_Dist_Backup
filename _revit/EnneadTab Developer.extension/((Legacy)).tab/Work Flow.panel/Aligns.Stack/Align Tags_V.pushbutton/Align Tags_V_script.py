...
__title__ = "Align Tags_V"
__doc__ = 'Align multiple tags vertically after picking the ref tag for head position and elbow position. The selection is pre-filtered to tags so you can over-select beforehand.'
direction = "V"
