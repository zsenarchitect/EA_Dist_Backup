__doc__ = "Prefix grid with user input text"
__title__ = "Prefix\nGrids"
...
prefix = forms.ask_for_string(prompt="Type below the name of the prefix, apply for the entire file", title="Name of the prefix")

with revit.Transaction("Prefix Grids"):
    for grid in grids:
        grid.Name = prefix + grid.Name
