__doc__ = "Find family file path. This does not remap the path. Contact Sen Zhang if you want to expand function to save all family to folder/sub-folder following a folder rule."
__title__ = "Family\nPath"
