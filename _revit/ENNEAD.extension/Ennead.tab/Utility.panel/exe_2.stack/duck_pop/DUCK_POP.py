...
def pop_message():
    ...
    app = DuckPopApp(text = data["main_text"],
                     ...
                     duck_image= data.get("duck_image", "L:\\4b_Applied Computing\\01_Revit\\04_Tools\\08_EA Extensions\\Published\\ENNEAD.extension\\Ennead.tab\\Utility.panel\\exe_2.stack\\duck_pop\\duck_small.png"),
